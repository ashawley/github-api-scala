...
trait LabelOp {
  ...
  private def doLabels(method: String, owner: String, repo: String, number: Long, labels: Seq[String]): Future[Seq[Label]] = {
  ...
  def addLabels(owner: String, repo: String, number: Long, labels: String*): Future[Seq[Label]] = {
    doLabels("POST", owner, repo, number, labels.to[Seq])
  }

  def replaceLabels(owner: String, repo: String, number: Long, labels: String*): Future[Seq[Label]] = {
    doLabels("PUT", owner, repo, number, labels.to[Seq])
  }

  def removeAllLabels(owner: String, repo: String, number: Long): Future[Seq[Label]] = {
    doLabels("PUT", owner, repo, number, Seq.empty[String])
  }

  def removeLabel(owner: String, repo: String, number: Long, label: String): Future[Seq[Label]] = {
  ...
  def listLabels(owner: String, repo: String, number: Long): Future[Seq[Label]] = {
    doLabels("GET", owner, repo, number, Seq.empty[String])
  }

  def listLabelDefs(owner: String, repo: String): Future[Seq[Label]] = {

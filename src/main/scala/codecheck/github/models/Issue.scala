...
case class IssueListOption(
  ...
  labels: Iterable[String] = Seq.empty[String],
...
object IssueInput {
  def apply(title: String, body: Option[String], assignee: Option[String], milestone: Option[Int], labels: Iterable[String]): IssueInput =
